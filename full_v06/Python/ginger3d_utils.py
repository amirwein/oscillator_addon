...
class run_g3d:
    ...
    home_dir     = '/Users/levikf/full_v06/Python/'
    ...
    def __init__(self, inp_dict, npass=400, master_seed=9876543):
        '''
        ...
        self.seed_table = rng.integers( low=1, high=2**31, size=(npass,2) )
    ...
    def make_2in_file(self, filename, passnum):
        '''
        ...
        filename : Str or Path
            Path to (or name of) the file being generated.
        passnum : int
            Pass number (for pass-specific seeding)
        ...
        with open(fPath, 'w') as f:
            ...
            iseeds = self.seed_table[passnum,:]
            f.write(f" iseeds(1:2)={iseeds[0]:d} {iseeds[1]:d}\n")
    ...
    def input_EE(self, reflect, ar=0, ai=0, EFFICIENT=False):
        ...
        # Treat subsequent passes differently
            ...
            self.make_2in_file(myinfile, passnum)
