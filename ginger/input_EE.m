function [E1,E2,delt,i0,dx,rad_s,rad_e,ebm_s,ebm_e]= input_EE(reflect,ar,ai,inp_struc)
%% function for Generating GINGER FIELD files
my_dir='/Users/amirweinberg/oscillator_addon/cent/';                            %Working Directory 
...
if reflect==1                                                              % First pass through undulator
    ...
    fld_file=my_dir+"fldUHM_G3D1.hdf5";                                    % Input field file
